...
public static class EndBossDatabase
{
    private static readonly HashSet<string> EndBossNames = new(StringComparer.Ordinal)
    {
        ...
        // already uploaded (see Web-Frontend/i18n.js) - per the client's own text she's
        ...
        "Bakım Amiri Notakiki", // tr (real nameplate table - the dic/encyclopedia table Web-Frontend/i18n.js was built from says "Bakım Müdiresi" instead, a discrepancy between the two tables just like Ukahim's Polish one)
        "维修班长诺塔奇奇", // zh

        // Stahlrose: Kabine (solo deck 2) - Accountant Kanerunerk, confirmed real and already
        // uploaded (see Web-Frontend/i18n.js), same reasoning as Notakiki above.
        ...
        // lookup elsewhere - see Web-Frontend/i18n.js's own remarks).
        "Captain Rumakiki", // en
