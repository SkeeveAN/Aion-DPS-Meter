...
public static class InstanceTierDatabase
{
    private static readonly Dictionary<string, LootTier> TierByBossName = new(StringComparer.Ordinal)
    {
        ...
        // GAME_NAME_TRANSLATIONS (see Web-Frontend/i18n.js) against client_strings_dic_monster.xml.
        ...
        // Web-Frontend/i18n.js's own remarks on how this was confirmed).
    ...
    /// Web-Frontend/i18n.js) but not independently re-checked against a live region-channel join
