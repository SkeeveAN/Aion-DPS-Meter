...
const TRANSLATIONS = {
  ...
  fr: {
    ...
    "breadcrumb.download": "Télécharger Aion DPS",
    ...
    "servers.emptyNoServers": "Aucun serveur enregistré pour le moment - envoyez le premier combat de boss via Aion DPS.",
    "servers.chooseHint":
    ...
    "instances.emptyNoInstances": "Aucune instance enregistrée pour le moment - envoyez le premier combat de boss via Aion DPS.",
  ...
  es: {
    ...
    "breadcrumb.download": "Descargar Aion DPS",
    ...
    "servers.emptyNoServers": "Aún no hay ningún servidor registrado - sube el primer combate contra un jefe con Aion DPS.",
    "servers.chooseHint":
    ...
    "instances.emptyNoInstances": "Aún no hay instancias registradas - sube el primer combate contra un jefe con Aion DPS.",
  ...
  ru: {
    ...
    "breadcrumb.download": "Скачать Aion DPS",
    ...
    "servers.emptyNoServers": "Пока не зафиксировано ни одного сервера - загрузи первый бой с боссом через Aion DPS.",
    "servers.chooseHint":
    ...
    "instances.emptyNoInstances": "Пока не зафиксировано ни одного инстанса - загрузи первый бой с боссом через Aion DPS.",
  ...
  pl: {
    ...
    "breadcrumb.download": "Pobierz Aion DPS",
    ...
    "servers.emptyNoServers": "Nie zarejestrowano jeszcze żadnego serwera - przesyłaj pierwszą walkę z bossem przez Aion DPS.",
    "servers.chooseHint":
    ...
    "instances.emptyNoInstances": "Nie zarejestrowano jeszcze żadnych instancji - przesyłaj pierwszą walkę z bossem przez Aion DPS.",
  ...
  tr: {
    ...
    "breadcrumb.download": "Aion DPS'i indir",
    ...
    "servers.emptyNoServers": "Henüz kayıtlı bir sunucu yok - Aion DPS üzerinden ilk boss savaşını yükleyin.",
    "servers.chooseHint":
    ...
    "instances.emptyNoInstances": "Henüz kayıtlı bir zindan yok - Aion DPS üzerinden ilk boss savaşını yükleyin.",
  ...
  zh: {
    ...
    "breadcrumb.download": "下载 Aion DPS",
    ...
    "servers.title": "选择服务器",
    "servers.emptyNoServers": "尚未记录任何服务器——请通过 Aion DPS 上传第一场首领战斗。",
    "servers.chooseHint": "不同服务器之间不具可比性（装备水平不同）——排行榜和玩家搜索始终只针对某一个服务器。",
    "servers.noDataYet": "尚未上传任何数据",
    "instances.emptyNoInstances": "尚未记录任何副本——请通过 Aion DPS 上传第一场首领战斗。",
