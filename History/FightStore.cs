...
public sealed class FightStore : IDisposable
{
    ...
    /// <summary>Compact JSON + gzip for the raw events. Ticks+Kind rather than ISO strings: the
    /// Chat.log timestamps are local, kind-unspecified values and must come back exactly so.</summary>
    private static class EventBlob
    {
